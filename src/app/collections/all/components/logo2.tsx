...
export default function Logo2({ d, styles }: { d: Logo2Data; styles: Logo2Styles }) {
  return (
    <span className={cn("border-2 border-solid border-accent block relative rounded-[50%] shrink-0 overflow-hidden bg-color-018 shadow-[var(--clr-36)_0px_1px_3px_0px] aspect-square 2xl:hidden", styles.className)}>
