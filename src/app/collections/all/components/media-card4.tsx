...
export default function MediaCard4({ d, styles }: { d: MediaCard4Data; styles: MediaCard4Styles }) {
  return (
    <div className="flex flex-col shrink-0 2xl:hidden">
      <a className="block cursor-pointer 2xl:hidden" data-component="link" aria-hidden="true" href="https://everhem.com/products/cafe-curtain-set">
      ...
      <div className="flex mb-3 flex-wrap items-center gap-1.5 2xl:hidden">
        ...
        <a className="block ml-0.5 text-color-004 text-xs leading-[1.1875rem] whitespace-nowrap cursor-pointer 2xl:hidden" data-component="link" href="https://everhem.com/products/cafe-curtain-set">
          +3 more collections
        </a>
      </div>
      <a className={cn("block cursor-pointer 2xl:hidden", styles.className)} data-component="link" href="https://everhem.com/products/cafe-curtain-set">
