...
export default function MediaCard5({ d }: { d: MediaCard5Data }) {
  return (
    <div className="flex flex-col shrink-0 2xl:hidden">
      <a className="block cursor-pointer 2xl:hidden" data-component="link" aria-hidden="true" href="https://everhem.com/collections/fixed-curtains">
      ...
      <div className="flex mb-3 flex-wrap items-center gap-1.5 2xl:hidden">
        ...
        <a className="block ml-0.5 text-color-004 text-xs leading-[1.1875rem] whitespace-nowrap cursor-pointer 2xl:hidden" data-component="link" href="https://everhem.com/collections/fixed-curtains">
          +3 more collections
        </a>
      </div>
      <a className="h-[41.1875px] block cursor-pointer 2xl:hidden" data-component="link" href="https://everhem.com/collections/fixed-curtains">
