...
export default function Tile({ d }: { d: TileData }) {
  return (
    <details className="border-b border-solid border-b-primary block 2xl:hidden">
      ...
      {" "}
      <div className="block pb-5.5 px-1 text-color-005 leading-[1.625rem] 2xl:hidden">
        <p className="block [overflow-wrap:break-word] 2xl:hidden">
          {d.description}
          <a className="inline text-foreground underline cursor-pointer 2xl:hidden" data-component="link" href={d.href}>
            {d.description2}
          </a>
          {d.description3}
        </p>
