...
export default function MediaTile({ d, styles }: { d: MediaTileData; styles: MediaTileStyles }) {
  return (
    <div className={cn("flex relative flex-col items-stretch gap-1 text-left 2xl:hidden", styles.className)} data-component="button" aria-label={d.ariaLabel} role="button" aria-disabled={d.ariadisabled}>
      ...
      {" "}
      <button className={cn("block text-color-002 text-xs font-medium leading-3 tracking-[1.44px] uppercase 2xl:hidden", styles.className2)} data-component="button" type="button" disabled={d.disabled}>
        Add swatch
      </button>
      {" "}
    </div>
