  ...
  return (
    <article className="flex flex-col 2xl:hidden">
      <div className="block mb-7 overflow-hidden bg-background aspect-[3/4] max-lg:mb-5 max-lg:aspect-[4/3] 2xl:hidden">
        <img className="w-full h-[30.9375rem] block max-w-full overflow-clip object-cover aspect-[auto_900/1200] max-md:h-64 md:max-lg:h-[33.8125rem] 2xl:hidden" data-component="image" alt="" height="1200" src={d.imgSrc} width="900" />
      </div>
      {" "}
