...
export default function MediaCard4({ d }: { d: MediaCard4Data }) {
  return (
    <article className="border border-solid border-color-006 flex p-6 flex-col gap-4 max-lg:p-4 2xl:hidden">
      <div className="block relative overflow-hidden bg-color-017 aspect-square 2xl:hidden">
      ...
      {" "}
      <p className="block opacity-75 text-color-009 text-sm font-light leading-[1.375rem] [overflow-wrap:break-word] 2xl:hidden">
        {d.description2}
      </p>
      {" "}
    </article>
