    ...
    <article className="flex flex-col 2xl:hidden">
      <div className="block relative mb-3 2xl:hidden">
        <div className="block relative overflow-hidden aspect-[3/4] bg-accent 2xl:hidden">
          <a className="block shrink-0 basis-full cursor-pointer aspect-[2/3] 2xl:hidden" data-component="link" href={d.href}>
            <img className={cn("w-full block max-w-full overflow-clip object-cover aspect-[auto_800/1066] max-md:h-[15.6875rem] md:max-lg:h-[33.0625rem] 2xl:hidden", styles.className)} data-component="image" alt={d.alt} height="1066" src={d.imgSrc} width="800" />
            {" "}
          </a>
        </div>
      </div>
      <div className="flex flex-col gap-0.5 2xl:hidden">
        ...
        <p className="block mb-1 text-color-015 text-xs leading-[1.0625rem] [overflow-wrap:break-word] 2xl:hidden">
          {d.description}
        </p>
      ...
      {" "}
      <div className={cn("flex gap-2 max-md:flex-col 2xl:hidden", styles.className2)}>
